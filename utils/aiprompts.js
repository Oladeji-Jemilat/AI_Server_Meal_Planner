...
Your task is to generate a STRICTLY VALID JSON fitness plan for the user below.
...
3. weeklyPlan MUST contain exactly 1 object inside the array.
4. Each week MUST include at least 3 workout days.
5. Each workout day MUST include 2–5 exercises only.
6. All numbers must be real numbers (not strings).
7. Do NOT return empty arrays anywhere.
8. Follow dietPreference strictly when generating meals.
9. Keep workouts safe, beginner-friendly, and realistic for the user's timePerDay.
10. Do not add extra fields outside the required structure.
